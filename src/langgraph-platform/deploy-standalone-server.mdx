...
3. The following environment variables are needed for a data plane deployment.
  ...
  5. `LANGSMITH_ENDPOINT`: To send traces to a [self-hosted LangSmith](/langsmith/archiectural-overview) instance, set `LANGSMITH_ENDPOINT` to the hostname of the self-hosted LangSmith instance.
