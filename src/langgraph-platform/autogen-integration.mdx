...
* Enhanced features: Add [persistence](/oss/langgraph/persistence), [streaming](/langgraph-platform/streaming), [short and long-term memory](/oss/langgraph/memory) and more to your AutoGen agents.
* Multi-agent systems: Build [multi-agent systems](/oss/langgraph/multi-agent) where individual agents are built with different frameworks.
