...
<Tip>
  **Prerequisites**
  This guide assumes familiarity with the [LangGraph Platform](/langgraph-platform/index), [Persistence](/oss/langgraph/persistence), and [Cross-thread persistence](/oss/langgraph/persistence#memory-store) concepts.
</Tip>
