...
<Info>
Requires LangSmith Python SDK version `langsmith>=0.4.26` for optimal
</Info>
...
In your Google ADK application, import and configure the LangSmith OpenTelemetry integration:
...
Alternatively, you can use the direct GoogleADKInstrumentor for more explicit control:
...
After running your Google ADK application, you can view the traces in your LangSmith dashboard. The traces will include:
