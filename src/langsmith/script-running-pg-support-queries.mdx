...
Before running the export scripts, you'll need to retrieve your customer information from the LangSmith API. This information is required as input for the export scripts.
...
You can use [jq](https://jqlang.org/download) to parse the JSON response and set bash variables for easy use in your scripts:
...
These environment variables can then be used in your export scripts or other commands.
