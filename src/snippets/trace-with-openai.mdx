...
For LangSmith API keys scoped to more than one workspace, set the `LANGSMITH_WORKSPACE_ID` environment variable to a workspace of your choosing to specify what workspace is being used.
