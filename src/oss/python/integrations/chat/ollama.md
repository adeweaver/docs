...
| Class | Package | Local | Serializable | [JS support](https://js.langchain.com/docs/integrations/chat/ollama) | Package downloads | Version |
| :--- | :--- | :---: | :---: |  :---: | :---: | :---: |
...
We can use [tool calling](/oss/concepts/tool_calling/) with an LLM [that has been fine-tuned for tool use](https://ollama.com/search?&c=tools) such as `gpt-oss`:
