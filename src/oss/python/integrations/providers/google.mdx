...
details in [this guide](/oss/integrations/chat/google_generative_ai).
...
Access the same Gemini models using the ([legacy](/oss/concepts/text_llms)) LLM
...
You can also use the ([legacy](/oss/concepts/text_llms)) string-in, string-out LLM
interface.
...
See [usage example](/oss/integrations/memory/google_alloydb).
...
See [usage example](/oss/integrations/memory/google_sql_pg).
...
See [usage example](/oss/integrations/memory/google_sql_mysql).
...
See [usage example](/oss/integrations/memory/google_sql_mssql).
...
See [usage example](/oss/integrations/memory/google_spanner).
...
See [usage example](/oss/integrations/memory/google_memorystore_redis).
...
See [usage example](/oss/integrations/memory/google_bigtable).
...
See [usage example](/oss/integrations/memory/google_firestore).
...
See [usage example](/oss/integrations/memory/google_firestore_datastore).
...
See [usage example](/oss/integrations/memory/google_el_carro).
