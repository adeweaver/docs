# Announcing LangChain v1

:::python
<Warning>
LangChain v1 is under active development and is not recommended for production use. APIs may change without notice, and the docs are incomplete and subject to change.
