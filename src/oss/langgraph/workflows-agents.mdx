...
You can use [any chat model](/oss/integrations/chat) that supports structured outputs and tool calling to build workflows and agents. To get started, install dependencies and then set your API keys like the Anthropic example below.
