...
You can use [any chat model](/oss/integrations/chat) that supports structured outputs and tool calling. Below, we show the process of installing the packages, setting API keys, and testing structured outputs and tool calling for Anthropic.
...
LLMs have augmentations that support building workflows and agents. These include [structured outputs](/oss/langchain-structured-output) and [tool calling](/oss/langchain-tools).
