...
You can [stream outputs](/oss/langgraph/streaming) from a LangGraph agent or workflow.
...
In some applications you might need to disable streaming of individual tokens for a given model. This is useful in [multi-agent](/oss/langgraph/multi-agent) systems to control which agents stream their output.

See the [Models](/oss/langgraph/models#disable-streaming) guide to learn how to disable streaming.
