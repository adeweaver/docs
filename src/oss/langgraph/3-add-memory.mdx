...
The chatbot can now [use tools](/oss/langgraph/2-add-tools) to answer user questions, but it does not remember the context of previous interactions. This limits its ability to have coherent, multi-turn conversations.
...
<Note>
  This tutorial builds on [Add tools](/oss/langgraph/2-add-tools).
</Note>
...
In the next tutorial, you will [add human-in-the-loop to the chatbot](/oss/langgraph/4-human-in-the-loop) to handle situations where it may need guidance or verification before proceeding.
