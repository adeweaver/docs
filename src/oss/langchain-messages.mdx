...
{/* ### <Icon icon="openai" size={16} /> OpenAI compatibility */}
...
<Tabs>
    <Tab title="Merging">
        <AccordionGroup>
        <Accordion title="Basic Message Merging">
        ...
        <Accordion title="Custom Merging Strategies">
            <CodeGroup>
  ...
  <Tab title="Deletion">
    <AccordionGroup>
      <Accordion title="Basic Message Deletion">
      ...
      <Accordion title="Selective Deletion Patterns">
        <CodeGroup>
...
<AccordionGroup>
    ...
    {/* TODO this is LangGraph focused? Probably re-write using content blocks? */}
...
{/* TODO: ensure these are covered in short-term memory docs  */}
{/*
### Checkpointers
