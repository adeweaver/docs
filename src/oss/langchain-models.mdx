...
The easiest way to get started with a model in LangChain is to use `init_chat_model` to initialize one from a model [provider](/oss/integrations/providers) of your choice.
