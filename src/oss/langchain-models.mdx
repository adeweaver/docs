...
:::js
The easiest way to get started with a model in LangChain is to use `initChatModel` to initialize one from a model [provider](/oss/integrations/providers) of your choice.
