...
[provider](/oss/integrations/providers) of your choice.
...
<Accordion title='"Auto-Streaming" Chat Models'>
    ...
    In [LangGraph agents](/oss/python/langchain-agents), for example, you can
...
[provider reference](/oss/integrations/providers) for details.
...
See the [agent guides](/oss/langchain-agents) to get started. Below, we show
...
see the [integrations page](/oss/integrations/providers).
...
the [messages](/oss/python/langchain-messages) guide.
