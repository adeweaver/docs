...
<Accordion title='"Auto-Streaming" Chat Models'>
    ...
    In [LangGraph agents](/oss/python/langchain-agents), for example, you can call
...
See the @[astream_events] API reference for event types and other details.
...
parameters. Check the respective [provider reference](/oss/integrations/providers) for
details.

<Tip>

See the [tools guide](/oss/langchain-tools) for details and other options for creating
tools.
...
[Agent guides](/oss/langchain-agents) to get started. Below, we show some simple
...
See the [Integrations page](/oss/integrations/providers) for details on your
specific providers.
...
[Integrations page](/oss/integrations/providers).
...
[messages](/oss/python/langchain-messages) guide.
