...
<ParamField path="tools" required>
    A list of tools that this node can execute. Can include: - LangChain `@tool` decorated functions - Callable objects (e.g. functions) with proper type hints and a docstring
</ParamField>
:::
