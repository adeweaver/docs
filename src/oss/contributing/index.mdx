...
<AccordionGroup>
    <Accordion title="Report bugs" icon="bug">
        ...
        <Steps>
            <Step title="Search">
                ...
                :::js
                <Columns cols={2}>
                    <Card title="LangChain" icon="link" href="https://github.com/langchain-ai/langchainjs" />
                    <Card title="LangGraph" icon="circle-nodes" href="https://github.com/langchain-ai/langgraphjs" />
                </Columns>
                :::
            </Step>
    ...
    <Accordion title="Contribute code" icon="code">
        ...
        :::js
        <Columns cols={2}>
            <Card title="LangChain" icon="link" href="https://github.com/langchain-ai/langchainjs/labels" />
            <Card title="LangGraph" icon="circle-nodes" href="https://github.com/langchain-ai/langgraphjs/labels" />
        </Columns>
        :::
    </Accordion>
