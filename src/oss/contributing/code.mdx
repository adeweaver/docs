...
<Steps>
    <Step title="Fork the repository">
        :::python
        Fork the [LangChain](https://github.com/langchain-ai/langchain) or [LangGraph](https://github.com/langchain-ai/langgraph) repo to your personal GitHub account
        :::
        :::js
...
:::python
<Warning>
    This project uses [`uv`](https://docs.astral.sh/uv/getting-started/installation/) for dependency management. Make sure you have the latest version of `uv` installed.
</Warning>
:::
:::js
<Warning>
    ...
    <Tab title="LangChain" icon="link">
        ...
        <AccordionGroup>
            <Accordion title="Core packages" defaultOpen>
                ...
                :::
                :::js
                - **`langchain-core` (located in `langchain-core/`)**: Base interfaces and core abstractions
                - **`langchain` (located in `langchain/`)**: Main package with chains, agents, and retrieval logic
                :::
            </Accordion>
            ...
            <Accordion title="Partner packages">
                ...
                :::
                - **`langchain-openai`**: [OpenAI](/oss/integrations/providers/openai) integrations
                - **`langchain-anthropic`**: [Anthropic](oss/integrations/providers/anthropic) integrations
                - **`langchain-google-genai`**: [Google Generative AI](/oss/integrations/chat/google_generative_ai) integrations
...
<Tabs>
    ...
    <Tab title="Documentation">
        ...
        **Required**: Google-style docstrings for all public functions
        :::
        :::js
        **Required**: TODO(style, see Python) for all public functions
        :::
    ...
    <Tab title="Code style">
        ...
        **Automated**: Formatting and linting:
        ...
        ```bash
        yarn lint    # Check style and types
        ...
        **Standards**:
        ...
        - Break up complex functions (aim for >20 lines)
...
We aim to keep the bar high for new features. We generally don't accept new core abstractions, changes to infra, changes to dependencies, or new agents/chains from outside contributors without an existing forum post discussion or issue that demonstrates an acute need for them.
