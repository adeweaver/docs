...
:::js
<Warning>
    This project uses [`pnpm`](https://pnpm.io/) for dependency management. Make sure you have the latest version of `pnpm` installed, or run `corepack enable` (on Node 24+) to setup the required pnpm version.
</Warning>
:::
