...
<Steps>
    <Step title="Fork the repository">
        :::python
        Fork the [LangChain](https://github.com/langchain-ai/langchain) or [LangGraph](https://github.com/langchain-ai/langgraph) repo to your GitHub account
        :::
        :::js
        Fork the [LangChain](https://github.com/langchain-ai/langchainjs) or [LangGraph](https://github.com/langchain-ai/langgraphjs) repo to your GitHub account
        :::
    </Step>
...
<Tabs>
    <Tab title="Core packages">
        ...
        cd libs/core
        uv sync --all-groups
        make test  # Ensure tests pass before developing
        ```
    </Tab>
...
<AccordionGroup>
    <Accordion title="Core packages" defaultOpen>
        - **`langchain-core`**: Base interfaces and core abstractions
        - **`langchain`**: Main package with chains, agents, and retrieval logic
    </Accordion>

    <Accordion title="Partner packages">
        Located in `libs/partners/`, these are independently versioned packages for specific integrations:
...
- **Community Slack**: Join our [community](https://www.langchain.com/join-community) for real-time help
