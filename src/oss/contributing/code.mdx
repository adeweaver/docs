...
<Note>
    ...
    This does not apply to bugfixes or small improvements, which you can contribute directly via pull requests. Be sure to link any relevant issues in your PR description.
</Note>
...
:::js
<Warning>
    This project uses [`pnpm`](https://pnpm.io/) for dependency management. Make sure you have the latest version of `pnpm` installed.
</Warning>
:::
...
<Tabs>
    <Tab title="Core packages">
        ...
        pnpm install
        pnpm test  # Ensure tests pass before starting development
        ```
        :::
    </Tab>
    ...
    :::
    :::js
    <Tab title="Provider packages">
        For changes to [partner integrations](/oss/integrations/providers):

        ```bash
        cd libs/providers/langchain-{partner}
        pnpm install
        pnpm test  # Ensure tests pass before starting development
        ```
    </Tab>
...
<Tabs>
    ...
    <Tab title="Documentation">
        ...
        **Required**: Google-style docstrings for all public functions
        :::
        :::js
        **Required**: JSDocs for all exported functions and interfaces
