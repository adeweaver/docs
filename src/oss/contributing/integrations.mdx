...
<Info>
    See the [Conceptual Guide](/oss/concepts) for an overview of all components supported in LangChain
</Info>
...
<Steps>
    ...
    <Step title="Implement your package">
        [Implement your package](/oss/contributing/how_to/integrations/package/) and publish it to a public GitHub repository.
    </Step>

    <Step title="Pass standard tests">
        [Implement the standard tests](/oss/contributing/standard-tests) for your integration and successfully run them.
    </Step>

    <Step title="Publish integration">
        [Publish your integration](/oss/contributing/how_to/integrations/publish) by publishing the package to PyPI and add docs in the `docs/docs/integrations` directory of the LangChain monorepo.
    </Step>
...
<Card title="Implement integration package" href="/oss/contributing/how_to/integrations/package" arrow />
