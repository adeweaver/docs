...
👉 [See integrations](/oss/integrations/document_loaders)
...
👉 [Embedding integrations](/oss/integrations/text_embedding)

#### Vector stores

Specialized databases for storing and searching embeddings.

👉 [Vector store integrations](/oss/integrations/vectorstores/)
...
<Tip>
All [vector stores](/oss/python/concepts/vectorstores) can be [cast to retrievers](/oss/python/how-to/vectorstore_retriever/).
</Tip>

👉 [Retriever integrations](/oss/integrations/retrievers/)
