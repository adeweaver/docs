...
For more details, see our [Installation guide](/oss/python/langchain-installation).
...
[RecursiveCharacterTextSplitter](/oss/python/integrations/splitters/recursive_text_splitter),
...
- [Overview](/oss/python/angchain-retrieval#vectorstores/)
- [Available integrations](/oss/python/integrations/vectorstores/)

For more on RAG, see:

- [Build a Retrieval Augmented Generation (RAG) App](/oss/python/tutorials/rag/)
