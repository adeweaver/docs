    ...
    <Tab title="LangChain" icon="link">
        ...
        <AccordionGroup>
            ...
            <Accordion title="Partner packages">
                ...
                - **`langchain-openai`**: [OpenAI](/oss/python/integrations/providers/openai) integrations
                - **`langchain-anthropic`**: [Anthropic](oss/integrations/providers/anthropic) integrations
                - **`langchain-google-genai`**: [Google Generative AI](/oss/python/integrations/chat/google_generative_ai) integrations
