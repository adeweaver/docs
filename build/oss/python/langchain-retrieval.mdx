...
👉 [**Tutorial**: Agentic RAG with Self-Correction](https://python.langchain.com/docs/tutorials/rag/)
...
👉 [See integrations](/oss/python/integrations/document_loaders)

#### Text splitters

Break large docs into smaller chunks that will be retrievable individually and fit within model context window limit.

👉 [Splitter how-tos](https://python.langchain.com/docs/how_to/#text-splitters)
...
👉 [Embedding integrations](/oss/python/integrations/text_embedding)

#### Vector stores

Specialized databases for storing and searching embeddings.

👉 [Vector store integrations](/oss/python/integrations/vectorstores/)

#### Retrievers

A [retriever](/oss/python/python/concepts/retrievers) is an interface that returns documents given an unstructured query.
...
Retrievers can be created from vector stores, but are also broad enough to include [Wikipedia search](/oss/python/python/integrations/retrievers/wikipedia/) and [Amazon Kendra](/oss/python/python/integrations/retrievers/amazon_kendra_retriever/).
...
<Tip>
All [vector stores](/oss/python/python/concepts/vectorstores) can be [cast to retrievers](/oss/python/python/how-to/vectorstore_retriever/).
</Tip>

👉 [Retriever integrations](/oss/python/integrations/retrievers/)
