...
See a [usage example](/oss/python/integrations/chat/azure)
...
```
See a [usage example](/oss/python/integrations/llms/azure).
...
```
See a [usage example](/oss/python/integrations/vectorstores/azure_aisearch).
...
```
See a [usage example](/oss/python/integrations/vectorstores/azure_cosmosdb_nosql).
...
npm install @langchain/azure-cosmosdb @langchain/core
```
See a [usage example](/oss/python/integrations/vectorstores/azure_cosmosdb_mongodb).
...
> The Semantic Cache feature is supported with Azure Cosmos DB for NoSQL integration, enabling users to retrieve cached responses based on semantic similarity between the user input and previously cached results. It leverages [AzureCosmosDBNoSQLVectorStore](/oss/python/integrations/vectorstores/azure_cosmosdb_nosql), which stores vector embeddings of cached prompts. These embeddings enable similarity-based searches, allowing the system to retrieve relevant cached results.
...
npm install @langchain/azure-cosmosdb @langchain/core
```
See a [usage example](/oss/python/integrations/llm_caching/azure_cosmosdb_nosql).
...
npm install @langchain/azure-cosmosdb @langchain/core
```
See [usage example](/oss/python/integrations/memory/azure_cosmosdb_nosql.mdx).
...
npm install @langchain/azure-cosmosdb @langchain/core
```
See a [usage example](/oss/python/integrations/memory/azure_cosmos_mongo_vcore.mdx).
...
```
See a [usage example for the Azure Blob Storage](/oss/python/integrations/document_loaders/web_loaders/azure_blob_storage_container).

```typescript
import { AzureBlobStorageContainerLoader } from "@langchain/community/document_loaders/web/azure_blob_storage_container";
```
See a [usage example for the Azure Files](/oss/python/integrations/document_loaders/web_loaders/azure_blob_storage_file).
