...
changes associated with the new message content. Refer to the new docs
[here](/oss/python/langchain-messages#content).
...
new docs [here](/oss/python/langchain-agents) and to the
...
Python 3.9 is [end of life](https://devguide.python.org/versions/) in October 2025.

</Accordion>

<Accordion title="Some legacy code moved to langchain-legacy package">
