...
TODO: 
- LangGraph prebuilt agents in LangChain
...
<AccordionGroup>
    ...
    <Accordion title="Provider-Specific Blocks" icon="plug">
        ...
        [reference documentation](/oss/python/integrations/providers) of each model provider.
    </Accordion>
</AccordionGroup>
...
1. **`.content_blocks` property** - Always returns typed content blocks (runtime conversion)
...
# Access new format via property
