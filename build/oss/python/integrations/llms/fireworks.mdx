...
<Warning>
**You are currently on a page documenting the use of Fireworks models as [text completion models](/oss/python/concepts/text_llms). Many popular Fireworks models are [chat completion models](/oss/python/concepts/chat_models).**
