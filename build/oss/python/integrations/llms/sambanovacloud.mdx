...
<Warning>
**You are currently on a page documenting the use of SambaNovaCloud models as [text completion models](/oss/python/concepts/text_llms/). We recommend you to use the [chat completion models](/oss/python/concepts/chat_models).**
