...
<Warning>
**You are currently on a page documenting the use of Together AI models as [text completion models](/oss/python/concepts/text_llms). Many popular Together AI models are [chat completion models](/oss/python/concepts/chat_models).**
