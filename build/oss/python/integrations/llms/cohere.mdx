...
<Warning>
**You are currently on a page documenting the use of Cohere models as [text completion models](/oss/python/concepts/text_llms). Many popular Cohere models are [chat completion models](/oss/python/concepts/chat_models).**
...
You can also easily combine with a prompt template for easy structuring of user input. We can do this using [LCEL](/oss/python/concepts/lcel)
