...
| [Tool calling](/oss/python/how-to/tool_calling/) | [Structured output](/oss/python/how-to/structured_output/) | [JSON mode](/oss/python/how-to/structured_output/#advanced-specifying-the-method-for-structuring-outputs) | [Image input](/oss/python/how-to/multimodal_inputs/) | Audio input | Video input | [Token-level streaming](/oss/python/how-to/chat_streaming/) | Native async | [Token usage](/oss/python/how-to/chat_token_usage_tracking/) | [Logprobs](/oss/python/how-to/logprobs/) |
| :---: | :---: | :---: | :---: |  :---: | :---: | :---: | :---: | :---: | :---: |
| ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ✅ | ❌ | ❌ | ❌ |
