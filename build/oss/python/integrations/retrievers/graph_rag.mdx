...
[retriever](/oss/python/concepts/retrievers/) that combines **unstructured** similarity search
...
4. Select [embeddings model](/oss/python/python/integrations/text_embedding):
...
via [chains](/oss/python/how-to/sequence/).
