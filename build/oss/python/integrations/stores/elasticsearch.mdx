...
Like other `ByteStores`, you can use an `ElasticsearchEmbeddingsCache` instance for [persistent caching in document ingestion](/oss/python/how-to/caching_embeddings/) for RAG.
