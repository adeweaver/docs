...
Next, we'll define a metadata function to extract the relevant metadata from the JSON record. We'll pass this function to the JSONLoader. See the [JSON document loader docs](/oss/python/how-to/document_loader_json) for more details.
...
For more on self-querying, [see the docs](/oss/python/how-to/self_query).
