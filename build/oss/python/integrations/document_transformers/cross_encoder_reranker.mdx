...
This builds on top of ideas in the [ContextualCompressionRetriever](/oss/python/how-to/contextual_compression). Overall structure of this document came from [Cohere Reranker documentation](/oss/python/integrations/retrievers/cohere-reranker).
