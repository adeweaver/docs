...
[Text splitters](/oss/python/langchain-retrieval#text-splitters) break large docs into smaller chunks that will be retrievable individually and fit within model context window limit.
