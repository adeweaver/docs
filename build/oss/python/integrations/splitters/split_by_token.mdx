...
Language models have a [token](/oss/python/concepts/tokens/) limit. You should not exceed the token limit. When you [split your text](/oss/python/concepts/text_splitters/) into chunks it is therefore a good idea to count the number of tokens. There are many tokenizers. When you count tokens in your text you should use the same tokenizer as used in the language model.
