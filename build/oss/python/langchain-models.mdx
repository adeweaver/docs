...
The easiest way to get started with a model in LangChain is to use `init_chat_model` to initialize one from a [provider](/oss/python/integrations/providers) of your choice:
...
<Note>
    Some provider APIs, notably OpenAI and Azure OpenAI chat completions, require users opt-in to receiving token usage data in streaming contexts. See [this section](/oss/python/integrations/chat/openai#streaming-usage-metadata) of the integration guide for details.
</Note>
