...
[provider](/oss/python/integrations/providers) of your choice.
...
<Accordion title='"Auto-Streaming" Chat Models'>
    ...
    In [LangGraph agents](/oss/python/python/langchain-agents), for example, you can
...
[provider reference](/oss/python/integrations/providers) for details.

<Tip>

See the [tools guide](/oss/python/langchain-tools) for details and other options for
creating tools.
...
See the [agent guides](/oss/python/langchain-agents) to get started. Below, we show
...
see the [integrations page](/oss/python/integrations/providers).
...
the [messages](/oss/python/python/langchain-messages) guide.
