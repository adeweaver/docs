...
The easiest way to get started with a model in LangChain is to use `init_chat_model` to initialize one from a model [provider](/oss/python/integrations/providers) of your choice.
...
<Note>
    ...
    vary by provider. Check the respective [reference](/oss/python/integrations/providers) for details.
</Note>
</Accordion>
...
<Note>
    ...
    [reference](/oss/python/integrations/providers) for proxy configuration options.
</Note>
