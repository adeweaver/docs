...
`init_chat_model()` to initialize one from a model [provider](/oss/python/integrations/providers) of
your choice.
...
<Info>
    ...
    [Integrations page](/oss/python/integrations/providers) for details.
</Info>
...
<Accordion title='"Auto-Streaming" Chat Models'>
    ...
    In [LangGraph agents](/oss/python/python/langchain-agents), for example, you can call
...
[astream_events](https://python.langchain.com/api_reference/core/language_models/langchain_core.language_models.chat_models.BaseChatModel.html#langchain_core.language_models.chat_models.BaseChatModel.astream_events) API.
...
See the [astream_events](https://python.langchain.com/api_reference/core/language_models/langchain_core.language_models.chat_models.BaseChatModel.html#langchain_core.language_models.chat_models.BaseChatModel.astream_events) API reference for event types and other details.
...
parameters. Check the respective [provider reference](/oss/python/integrations/providers) for
details.

<Tip>

See the [tools guide](/oss/python/langchain-tools) for details and other options for creating
tools.
...
[Agent guides](/oss/python/langchain-agents) to get started. Below, we show some simple
...
See the [Integrations page](/oss/python/integrations/providers) for details on your
specific providers.
...
[Integrations page](/oss/python/integrations/providers).
...
[messages](/oss/python/python/langchain-messages) guide.
...
[this section](/oss/python/integrations/chat/openai#streaming-usage-metadata) of the
