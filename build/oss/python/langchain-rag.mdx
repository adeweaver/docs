...
<Note>
Here we focus on Q&A for unstructured data. If you are interested for RAG over structured data, check out our tutorial on doing [question/answering over SQL data](/oss/python/langchain-sql-qa).
</Note>
...
[RecursiveCharacterTextSplitter](/oss/python/integrations/recursive_text_splitter),
