...
![Screenshot 2024-02-14 at 3.43.58 PM.png](/oss/images/screenshot_2024_02_14_3_43_58_pm.png)
...
Now we will start building components ([nodes](/oss/python/graph-api#nodes) and [edges](/oss/python/graph-api#edges)) for our agentic RAG graph.

Note that the components will operate on the [`MessagesState`](/oss/python/graph-api#messagesstate) — graph state that contains a `messages` key with a list of [chat messages](https://python.langchain.com/docs/concepts/messages/).
...
![Graph](/oss/images/agentic-rag-output.png)
