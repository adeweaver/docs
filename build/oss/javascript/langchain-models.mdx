...
<Note>
    Some provider APIs, notably OpenAI and Azure OpenAI chat completions, require users opt-in to receiving token usage data in streaming contexts. See [this section](/oss/javascript/integrations/chat/openai#streaming-usage-metadata) of the integration guide for details.
</Note>
