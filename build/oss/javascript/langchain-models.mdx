...
<Info>
    ...
    [reference docs](https://v03.api.js.langchain.com/index.html).
</Info>
...
<Accordion title='"Auto-Streaming" Chat Models'>
    ...
    Callback events allow LangGraph `stream()` and [`streamEvents()`](https://v03.api.js.langchain.com/classes/_langchain_core.language_models_chat_models.BaseChatModel.html#streamEvents)
