...
<Note>
Here we focus on Q&A for unstructured data. If you are interested for RAG over structured data, check out our tutorial on doing [question/answering over SQL data](/oss/javascript/langchain-sql-qa).
</Note>
...
For more details, see our [Installation guide](/oss/javascript/langchain-installation).
...
[WebBaseLoader](/oss/javascript/integrations/document_loaders/web_base),
...
[RecursiveCharacterTextSplitter](/oss/javascript/integrations/recursive_text_splitter),
...
- [Integrations](/oss/javascript/integrations/splitters/)
