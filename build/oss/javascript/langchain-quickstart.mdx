...
[Tools](/oss/javascript/langchain-tools) are functions your agent can call. They should be well-documented.
...
Structured outputs ensure your agent returns data in a predictable format. Here,
we use Python's [`DataClass`](https://docs.python.org/3/library/dataclasses.html)
dictionary.
