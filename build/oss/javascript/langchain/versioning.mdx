---
title: LangChain Versioning
---

Each LangChain version number follows the format: `MAJOR.MINOR.PATCH`
...
- [Release Policy](/oss/javascript/langchain/release-policy) - Detailed release and deprecation policies
- [Migration Guides](/oss/javascript/langchain/releases) - Version-specific migration guides