...
Now we will start building components ([nodes](/oss/javascript/graph-api#nodes) and [edges](/oss/javascript/graph-api#edges)) for our agentic RAG graph.
