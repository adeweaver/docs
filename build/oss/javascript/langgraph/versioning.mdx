---
title: LangGraph Versioning
---

Each LangGraph version number follows the format: `MAJOR.MINOR.PATCH`
...
- [Release Policy](/oss/javascript/langgraph/release-policy) - Detailed release and deprecation policies
- [Releases](/oss/javascript/langgraph/releases) - Version-specific release notes and migration guides