...
We can easily combine this message history class with [LCEL Runnables](/oss/javascript/how-to/message_history)

To do this we will use one of [Google's Vertex AI chat models](/oss/javascript/integrations/chat/google_vertex_ai_palm) which requires that you [enable the Vertex AI API](https://console.cloud.google.com/flows/enableapi?apiid=aiplatform.googleapis.com) in your Google Cloud Project.
