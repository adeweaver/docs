...
To create a Redis byte store, you'll need to set up a Redis instance. You can do this locally or via a provider - see our [Redis guide](/oss/javascript/integrations/providers/redis) for an overview of options.
