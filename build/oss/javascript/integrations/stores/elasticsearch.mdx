...
Like other `ByteStores`, you can use an `ElasticsearchEmbeddingsCache` instance for [persistent caching in document ingestion](/oss/javascript/how-to/caching_embeddings/) for RAG.
