...
You can use the [`ExaSearchRetriever`](/oss/javascript/integrations/tools/exa_search#using-exasearchretriever) in a standard retrieval pipeline. You can import it as follows.

See a [usage example](/oss/javascript/integrations/tools/exa_search).
...
You can use Exa as an agent tool as described in the [Exa tool calling docs](/oss/javascript/integrations/tools/exa_search#use-within-an-agent).
