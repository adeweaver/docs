...
See a [usage example](/oss/javascript/integrations/chat/azure_chat_openai)
...
See a [usage example](/oss/javascript/integrations/chat/azure_ai)

### Azure ML Chat Online Endpoint

See the documentation [here](/oss/javascript/integrations/chat/azureml_chat_endpoint) for accessing chat
...
See a [usage example](/oss/javascript/integrations/llms/azure_ml).
...
See a [usage example](/oss/javascript/integrations/llms/azure_openai).
...
See a [usage example](/oss/javascript/integrations/text_embedding/azureopenai)
...
See a [usage example](/oss/javascript/integrations/document_loaders/azure_ai_data).
...
See a [usage example](/oss/javascript/integrations/document_loaders/azure_document_intelligence).
...
See a [usage example for the Azure Blob Storage](/oss/javascript/integrations/document_loaders/azure_blob_storage_container).

```python
from langchain_community.document_loaders import AzureBlobStorageContainerLoader
```

See a [usage example for the Azure Files](/oss/javascript/integrations/document_loaders/azure_blob_storage_file).
...
See a [usage example](/oss/javascript/integrations/document_loaders/microsoft_onedrive).
...
See a [usage example](/oss/javascript/integrations/document_loaders/microsoft_word).
...
See a [usage example](/oss/javascript/integrations/document_loaders/microsoft_excel).
...
See a [usage example](/oss/javascript/integrations/document_loaders/microsoft_sharepoint).
...
See a [usage example](/oss/javascript/integrations/document_loaders/microsoft_powerpoint).
...
See a [usage example](/oss/javascript/integrations/document_loaders/microsoft_onenote).
...
See a [usage example](/oss/javascript/integrations/document_loaders/url/#playwright-url-loader).
...
See [detail configuration instructions](/oss/javascript/integrations/vectorstores/azure_cosmos_db).
...
See a [usage example](/oss/javascript/integrations/vectorstores/azure_cosmos_db).
...
See [detail configuration instructions](/oss/javascript/integrations/vectorstores/azure_cosmos_db_no_sql).
...
See a [usage example](/oss/javascript/integrations/vectorstores/azure_cosmos_db_no_sql).
...
See a [usage example](/oss/javascript/integrations/memory/postgres_chat_message_history/). Simply use the [connection string](https://learn.microsoft.com/en-us/azure/postgresql/flexible-server/connect-python?tabs=cmd%2Cpassword#add-authentication-code) from your Azure Portal.

Since Azure Database for PostgreSQL is open-source Postgres, you can use the [LangChain's Postgres support](/oss/javascript/integrations/vectorstores/pgvector/) to connect to Azure Database for PostgreSQL.
...
See [detail configuration instructions](/oss/javascript/integrations/vectorstores/sqlserver).
...
See a [usage example](/oss/javascript/integrations/vectorstores/sqlserver).
...
queries at scale. See [here](/oss/javascript/integrations/vectorstores/azuresearch) for usage examples.
...
See a [usage example](/oss/javascript/integrations/retrievers/azure_ai_search).
...
You need to [enable pgvector extension](https://learn.microsoft.com/en-us/azure/postgresql/flexible-server/how-to-use-pgvector) in your database to use Postgres as a vector store. Once you have the extension enabled, you can use the [PGVector in LangChain](/oss/javascript/integrations/vectorstores/pgvector/) to connect to Azure Database for PostgreSQL.

See a [usage example](/oss/javascript/integrations/vectorstores/pgvector/). Simply use the [connection string](https://learn.microsoft.com/en-us/azure/postgresql/flexible-server/connect-python?tabs=cmd%2Cpassword#add-authentication-code) from your Azure Portal.
...
See the instructions [here](/oss/javascript/integrations/tools/azure_dynamic_sessions/#setup).
...
Follow the documentation [here](/oss/javascript/integrations/tools/bing_search) to get a detail explanations and instructions of this tool.
...
See a [usage example](/oss/javascript/integrations/tools/azure_ai_services).
...
See a [usage example](/oss/javascript/integrations/tools/azure_cognitive_services).
...
See a [usage example](/oss/javascript/integrations/tools/office365).
...
See a [usage example](/oss/javascript/integrations/tools/powerbi).
...
See a [usage example](/oss/javascript/integrations/tools/playwright).
...
See a [usage example](/oss/javascript/integrations/graphs/azure_cosmosdb_gremlin).
...
See a [usage example](/oss/javascript/integrations/tools/bing_search).
