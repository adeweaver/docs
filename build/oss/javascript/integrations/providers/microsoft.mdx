...
npm install @langchain/azure-cosmosdb @langchain/core
```
See [usage example](/oss/javascript/integrations/memory/azure_cosmosdb_nosql.mdx).
...
npm install @langchain/azure-cosmosdb @langchain/core
```
See a [usage example](/oss/javascript/integrations/memory/azure_cosmos_mongo_vcore.mdx).
