...
For more on Netmind chat models, visit the guide [here](/oss/javascript/integrations/chat/netmind)

## Embedding Model

For more on Netmind embedding models, visit the [guide](/oss/javascript/integrations/text_embedding/netmind)
