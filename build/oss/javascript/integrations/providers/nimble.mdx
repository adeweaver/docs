...
See a [usage example](/oss/javascript/integrations/retrievers/nimble/).

```python
from langchain_nimble import NimbeSearchRetriever
```

Note that authentication is required, please refer to the [Setup section in the documentation](/oss/javascript/integrations/retrievers/nimble/#setup).
