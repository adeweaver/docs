...
See a [usage example](/oss/javascript/integrations/vectorstores/falkordbvector.ipynb)

## Memory

See a [usage example](/oss/javascript/integrations/memory/falkordb_chat_message_history.ipynb).
