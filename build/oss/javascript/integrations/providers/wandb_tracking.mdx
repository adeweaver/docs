...
To know more about the `WandbTracer` refer to the [agent_with_wandb_tracing](/oss/javascript/integrations/providers/wandb_tracing) notebook or use the following [colab notebook](http://wandb.me/prompts-quickstart).
