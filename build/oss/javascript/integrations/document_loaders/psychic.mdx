...
This notebook covers how to load documents from `Psychic`. See [here](/oss/javascript/integrations/providers/psychic) for more details.

## Prerequisites

1. Follow the Quick Start section in [this document](/oss/javascript/integrations/providers/psychic)
