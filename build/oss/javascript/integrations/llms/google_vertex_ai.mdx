...
<Warning>
**You are currently on a page documenting the use of Google Vertex models as [text completion models](/oss/javascript/concepts/text_llms). Many popular models available on Google Vertex are [chat completion models](/oss/javascript/concepts/chat_models).**
