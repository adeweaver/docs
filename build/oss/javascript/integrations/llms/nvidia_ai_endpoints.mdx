...
This will help you get started with NVIDIA [models](/oss/javascript/concepts/text_llms). For detailed documentation of all `NVIDIA` features and configurations head to the [API reference](https://python.langchain.com/api_reference/nvidia_ai_endpoints/llms/langchain_nvidia_ai_endpoints.chat_models.NVIDIA.html).
...
| JSON mode | [Image input](/oss/javascript/how-to/multimodal_inputs/) | Audio input | Video input | [Token-level streaming](/oss/javascript/how-to/chat_streaming/) | Native async | [Token usage](/oss/javascript/how-to/chat_token_usage_tracking/) | [Logprobs](/oss/javascript/how-to/logprobs/) |
| :---: | :---: |  :---: | :---: | :---: | :---: | :---: | :---: |
| ❌ | ✅ | ❌ | ❌ | ✅ | ❌ | ❌ | ❌ |
