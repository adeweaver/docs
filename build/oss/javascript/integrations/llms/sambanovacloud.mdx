...
<Warning>
**You are currently on a page documenting the use of SambaNovaCloud models as [text completion models](/oss/javascript/concepts/text_llms/). We recommend you to use the [chat completion models](/oss/javascript/concepts/chat_models).**

You may be looking for [SambaNovaCloud Chat Models](/oss/javascript/integrations/chat/sambanova/) .
</Warning>
