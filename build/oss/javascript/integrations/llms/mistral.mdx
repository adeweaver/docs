...
You are currently on a page documenting the use of Mistral models as [text completion models](/oss/javascript/concepts/text_llms). Many popular models available on Mistral are [chat completion models](/oss/javascript/concepts/chat_models).
