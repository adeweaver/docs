...
<Warning>
**You are currently on a page documenting the use of SambaStudio models as [text completion models](/oss/javascript/concepts/text_llms). We recommend you to use the [chat completion models](/oss/javascript/concepts/chat_models).**

You may be looking for [SambaStudio Chat Models](/oss/javascript/integrations/chat/sambastudio/) .
</Warning>
