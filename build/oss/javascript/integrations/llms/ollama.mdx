...
<Warning>
**You are currently on a page documenting the use of Ollama models as [text completion models](/oss/javascript/concepts/text_llms). Many popular models available on Ollama are [chat completion models](/oss/javascript/concepts/chat_models).**


You may be looking for [this page instead](/oss/javascript/integrations/chat/ollama/).
</Warning>

This will help you get started with Ollama [text completion models (LLMs)](/oss/javascript/concepts/text_llms) using LangChain. For detailed documentation on `Ollama` features and configuration options, please refer to the [API reference](https://api.js.langchain.com/classes/langchain_ollama.Ollama.html).
...
We can [chain](/oss/javascript/how-to/sequence/) our completion model with a prompt template like so:
...
- LLM [conceptual guide](/oss/javascript/concepts/text_llms)
- LLM [how-to guides](/oss/javascript/how-to/#llms)
