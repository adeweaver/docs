...
This guide provides a quick overview for getting started with Weaviate [vector stores](/oss/javascript/concepts/#vectorstores). For detailed documentation of all `WeaviateStore` features and configurations head to the [API reference](https://api.js.langchain.com/classes/langchain_weaviate.WeaviateStore.html).
