...
This guide provides a quick overview for getting started with Qdrant [vector stores](/oss/javascript/concepts/#vectorstores). For detailed documentation of all `QdrantVectorStore` features and configurations head to the [API reference](https://api.js.langchain.com/classes/langchain_qdrant.QdrantVectorStore.html).
...
You can also transform the vector store into a [retriever](/oss/javascript/concepts/retrievers) for easier usage in your chains.
...
- [Tutorials: working with external knowledge](/oss/javascript/tutorials/#working-with-external-knowledge).
- [How-to: Question and answer with RAG](/oss/javascript/how-to/#qa-with-rag)
- [Retrieval conceptual docs](/oss/javascript/concepts/retrieval)
