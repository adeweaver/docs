...
2. [Implement your package](/oss/javascript/integrations/contributing/package/) and publish it to a public github repository.
3. [Implement the standard tests](/oss/javascript/integrations/contributing/standard_tests) for your integration and successfully run them.
4. [Publish your integration](/oss/javascript/integrations/contributing/publish) by publishing the package to PyPi and add docs in the `docs/docs/integrations` directory of the LangChain monorepo.
...
## Further reading
To get started, let's learn [how to implement an integration package](/oss/javascript/integrations/contributing/package/) for LangChain.
