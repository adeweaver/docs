...
- `langchain-tests` will provide the standard tests we want to use, as well as pytest plugins necessary to run them. Recommended to pin to the [latest version](https://pypi.org/project/langchain-tests/).
...
For example, below is the `VectorStoreIntegrationTests` class for the [Chroma](/oss/javascript/integrations/vectorstores/chroma/)
integration:
