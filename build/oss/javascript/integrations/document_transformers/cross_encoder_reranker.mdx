...
This builds on top of ideas in the [ContextualCompressionRetriever](/oss/javascript/how-to/contextual_compression). Overall structure of this document came from [Cohere Reranker documentation](/oss/javascript/integrations/retrievers/cohere-reranker).
