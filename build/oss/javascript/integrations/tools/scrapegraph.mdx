...
This guide provides a quick overview for getting started with ScrapeGraph [tools](/oss/javascript/integrations/tools/). For detailed documentation of all ScrapeGraph features and configurations head to the [API reference](https://python.langchain.com/docs/integrations/tools/scrapegraph).
...
### [Invoke directly with args](/oss/javascript/concepts/tools)
...
### [Invoke with ToolCall](/oss/javascript/concepts/tools)
