...
Embedding models are often used in retrieval-augmented generation (RAG) flows, both as part of indexing data as well as later retrieving it. For more detailed instructions, please see our RAG tutorials under the [working with external knowledge tutorials](/oss/javascript/tutorials/#working-with-external-knowledge).
...
- Embedding model [conceptual guide](/oss/javascript/concepts/embedding_models)
- Embedding model [how-to guides](/oss/javascript/how-to/#embedding-models)
