...
| [Tool calling](/oss/javascript/how-to/tool_calling/) | [Structured output](/oss/javascript/how-to/structured_output/) | [JSON mode](/oss/javascript/how-to/structured_output/#advanced-specifying-the-method-for-structuring-outputs) | [Image input](/oss/javascript/how-to/multimodal_inputs/) | Audio input | Video input | [Token-level streaming](/oss/javascript/how-to/chat_streaming/) | Native async | [Token usage](/oss/javascript/how-to/chat_token_usage_tracking/) | [Logprobs](/oss/javascript/how-to/logprobs/) |
| :---: | :---: | :---: | :---: |  :---: | :---: | :---: | :---: | :---: | :---: |
| ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ✅ | ❌ | ❌ | ❌ |
