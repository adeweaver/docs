...
This guide will help you getting started with `ChatXAI` [chat models](/oss/javascript/concepts/chat_models). For detailed documentation of all `ChatXAI` features and configurations head to the [API reference](https://api.js.langchain.com/classes/_langchain_xai.ChatXAI.html).
