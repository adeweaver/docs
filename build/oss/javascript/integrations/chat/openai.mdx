...
This guide will help you getting started with ChatOpenAI [chat models](/oss/javascript/concepts/chat_models). For detailed documentation of all ChatOpenAI features and configurations head to the [API reference](https://api.js.langchain.com/classes/langchain_openai.ChatOpenAI.html).
...
| [Tool calling](/oss/javascript/how-to/tool_calling) | [Structured output](/oss/javascript/how-to/structured_output/) | JSON mode | [Image input](/oss/javascript/how-to/multimodal_inputs/) | Audio input | Video input | [Token-level streaming](/oss/javascript/how-to/chat_streaming/) | [Token usage](/oss/javascript/how-to/chat_token_usage_tracking/) | [Logprobs](/oss/javascript/how-to/logprobs/) |
| :---: | :---: | :---: | :---: |  :---: | :---: | :---: | :---: | :---: |
| ✅ | ✅ | ✅ | ✅ | ❌ | ❌ | ✅ | ✅ | ✅ |
...
Tool calling with OpenAI models works in a similar to [other models](/oss/javascript/how-to/tool_calling). Additionally, the following guides have some information especially relevant to OpenAI:

- [How to: disable parallel tool calling](/oss/javascript/how-to/tool_calling_parallel/)
- [How to: force a tool call](/oss/javascript/how-to/tool_choice/)
- [How to: bind model-specific tool formats to a model](/oss/javascript/how-to/tool_calling#binding-model-specific-formats-advanced).
...
The below points apply to `@langchain/openai>=0.4.5-rc.0`. Please see here for a [guide on upgrading](/oss/javascript/how-to/installation/#installing-integration-packages).

</Warning>

OpenAI supports a [Responses](https://platform.openai.com/docs/guides/responses-vs-chat-completions) API that is oriented toward building [agentic](/oss/javascript/concepts/agents/) applications. It includes a suite of [built-in tools](https://platform.openai.com/docs/guides/tools?api-mode=responses), including web and file search. It also supports management of [conversation state](https://platform.openai.com/docs/guides/conversation-state?api-mode=responses), allowing you to continue a conversational thread without explicitly passing in previous messages.
...
Equipping `ChatOpenAI` with built-in tools will ground its responses with outside information, such as via context in files or the web. The [AIMessage](/oss/javascript/concepts/messages/#aimessage) generated from the model will include information about the built-in tool invocation.
