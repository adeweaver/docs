...
This guide will help you getting started with `ChatOllama` [chat models](/oss/javascript/concepts/chat_models). For detailed documentation of all `ChatOllama` features and configurations head to the [API reference](https://api.js.langchain.com/classes/langchain_ollama.ChatOllama.html).
...
You can pass images as part of a message's `content` field to [multimodal-capable](/oss/javascript/how-to/multimodal_inputs/) models like this:
