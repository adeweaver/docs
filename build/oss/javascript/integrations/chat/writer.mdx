...
This guide provides a quick overview for getting started with Writer [chat](/oss/javascript/concepts/chat_models/).
...
| [Tool calling](/oss/javascript/how-to/tool_calling) | Structured output | JSON mode | Image input | Audio input | Video input | [Token-level streaming](/oss/javascript/how-to/chat_streaming/) | Native async |         [Token usage](/oss/javascript/how-to/chat_token_usage_tracking/)          | Logprobs |
| :---: |:-----------------:| :---: | :---: |  :---: | :---: | :---: | :---: |:--------------------------------:|:--------:|
| ✅ |         ❌         | ❌ | ❌ | ❌ | ❌ | ✅ | ✅ |                ✅                 |    ❌     |
