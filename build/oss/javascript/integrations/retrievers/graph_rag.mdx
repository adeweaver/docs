...
[retriever](/oss/javascript/concepts/retrievers/) that combines **unstructured** similarity search
...
4. Select [embeddings model](/oss/javascript/python/integrations/text_embedding):
...
<Tabs groupId="vector-store" queryString>
  <Tab title="AstraDB">
    <div style={{ paddingLeft: '30px' }}>
      ...
      consult the [AstraDB Vector Store Guide](/oss/javascript/integrations/vectorstores/astradb).
  ...
  <Tab title="Apache Cassandra">
    <div style={{ paddingLeft: '30px' }}>
      ...
      [Apache Cassandra Vector Store Guide](/oss/javascript/integrations/vectorstores/cassandra#connection-parameters)
  ...
  <Tab title="OpenSearch">
    <div style={{ paddingLeft: '30px' }}>
      ...
      [OpenSearch Vector Store Guide](/oss/javascript/integrations/vectorstores/opensearch).
    </div>
  </Tab>
  <Tab title="Chroma">
    <div style={{ paddingLeft: '30px' }}>
      ...
      [Chroma Vector Store Guide](/oss/javascript/integrations/vectorstores/chroma).
...
via [chains](/oss/javascript/how-to/sequence/).
