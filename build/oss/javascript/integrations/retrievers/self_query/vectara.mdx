...
This guide will help you getting started with such a retriever backed by a [Vectara vector store](/oss/javascript/integrations/vectorstores/vectara). For detailed documentation of all features and configurations head to the [API reference](https://api.js.langchain.com/classes/langchain.retrievers_self_query.SelfQueryRetriever.html).
...
Set up a Vectara instance as documented [here](/oss/javascript/integrations/vectorstores/vectara). Set the following environment variables:
...
Like other retrievers, Vectara self-query retrievers can be incorporated into LLM applications via [chains](/oss/javascript/how-to/sequence/).
