...
This guide will help you getting started with such a retriever backed by a [Weaviate vector store](/oss/javascript/integrations/vectorstores/weaviate). For detailed documentation of all features and configurations head to the [API reference](https://api.js.langchain.com/classes/langchain.retrievers_self_query.SelfQueryRetriever.html).
...
Set up a Weaviate instance as documented [here](/oss/javascript/integrations/vectorstores/weaviate). Set the following environment variables if relevant:
...
Like other retrievers, Weaviate self-query retrievers can be incorporated into LLM applications via [chains](/oss/javascript/how-to/sequence/).
