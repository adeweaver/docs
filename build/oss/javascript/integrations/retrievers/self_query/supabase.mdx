...
Set up a Supabase instance as documented [here](/oss/javascript/integrations/vectorstores/supabase). Set the following environment variables:
...
Like other retrievers, Supabase self-query retrievers can be incorporated into LLM applications via [chains](/oss/javascript/how-to/sequence/).
