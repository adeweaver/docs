...
This guide will help you getting started with such a retriever backed by a [Chroma vector store](/oss/javascript/integrations/vectorstores/chroma). For detailed documentation of all features and configurations head to the [API reference](https://api.js.langchain.com/classes/langchain.retrievers_self_query.SelfQueryRetriever.html).
...
Set up a Chroma instance as documented [here](/oss/javascript/integrations/vectorstores/chroma).
...
Like other retrievers, Chroma self-query retrievers can be incorporated into LLM applications via [chains](/oss/javascript/how-to/sequence/).
