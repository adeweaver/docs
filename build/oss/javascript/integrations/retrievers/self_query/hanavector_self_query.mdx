...
For more information on how to setup the SAP HANA vetor store, take a look at the [documentation](/oss/javascript/integrations/vectorstores/sap_hanavector.ipynb).
