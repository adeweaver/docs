...
In this example, we're going to use the `KayAiRetriever`. Take a look at the [kay notebook](/oss/javascript/integrations/retrievers/kay) for more detailed information for the parameters that it accepts.`
