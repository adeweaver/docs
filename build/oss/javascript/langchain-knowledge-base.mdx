...
[RecursiveCharacterTextSplitter](/oss/javascript/integrations/splitters/recursive_text_splitter),
...
- [Overview](/oss/javascript/angchain-retrieval#vectorstores/)
- [Available integrations](/oss/javascript/integrations/vectorstores/)

For more on RAG, see:

- [Build a Retrieval Augmented Generation (RAG) App](/oss/javascript/tutorials/rag/)
