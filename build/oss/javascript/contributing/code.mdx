    ...
    <Tab title="LangChain" icon="link">
        ...
        <AccordionGroup>
            ...
            <Accordion title="Partner packages">
                ...
                - **`langchain-openai`**: [OpenAI](/oss/javascript/integrations/providers/openai) integrations
                - **`langchain-anthropic`**: [Anthropic](oss/integrations/providers/anthropic) integrations
                - **`langchain-google-genai`**: [Google Generative AI](/oss/javascript/integrations/chat/google_generative_ai) integrations
