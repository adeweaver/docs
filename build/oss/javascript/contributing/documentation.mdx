...
<Steps>
    ...
    <Step title="Fork the repository">
        GitHub will prompt you to fork the repository to your account. Make sure to fork into your personal account, **not an organization**
    </Step>
...
<Steps>
    <Step title="Install dependencies">
        You will need to install [`uv`](https://docs.astral.sh/uv/getting-started/installation/) and [`mint`](https://mintlify.com/docs/installation) if you haven't already.
