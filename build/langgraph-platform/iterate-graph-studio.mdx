...
sidebarTitle: Iterate on prompts
---
## Overview
...
The [LangSmith Playground](/langsmith/create-a-prompt) interface allows testing individual LLM calls without running the full graph:
