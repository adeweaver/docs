...
![The LangGraph CLI creates a LangGraph Server instance. LangGraph studio can interact with LangGraph Server. RemoteGraph and the SDKs can also interact with LangGraph Server.](/langgraph-platform/images/lg-platform.png)
...
* Manage [long term memory](/oss/python/langgraph/memory)
* Debug agent state via [time travel](/oss/python/langgraph/time-travel)
