...
![chatbot-with-tools-diagram](/langgraph-platform/langgraph-basics/chatbot-with-tools.png)
...
To resume execution, pass a [`Command`](/oss/python/langgraph/graph-api#command) object containing data expected by the tool. The format of this data can be customized based on needs. For this example, use a dict with a key `"data"`:
