...
---
To review, edit, and approve tool calls in an agent or workflow, use LangGraph's [human-in-the-loop](/oss/python/langgraph/human-in-the-loop) features.
...
* [Human-in-the-loop conceptual guide](/oss/python/langgraph/human-in-the-loop): learn more about LangGraph human-in-the-loop features.
