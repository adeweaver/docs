...
* Enhanced features: Add [persistence](/oss/python/langgraph/persistence), [streaming](/langgraph-platform/streaming), [short and long-term memory](/oss/python/langgraph/memory) and more to your AutoGen agents.
* Multi-agent systems: Build [multi-agent systems](/oss/python/langgraph/multi-agent) where individual agents are built with different frameworks.
