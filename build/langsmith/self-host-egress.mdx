...
<Warning>
  **This will require egress to `https://beacon.langchain.com` from your network.** Refer to our [whitelisting IP section](/langsmith/cloud-architecture-and-scalability) for static IP addresses, if needed.
</Warning>
