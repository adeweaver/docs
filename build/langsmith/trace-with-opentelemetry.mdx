...
1. Install the LangSmith package with OpenTelemetry support:
   ...
   <Info>
   Requires Python SDK version `langsmith>=0.3.18`. And we recommend `langsmith>=0.4.25` to include important OpenTelemetry fixes.
   </Info>
...
<Info>
Hybrid tracing exists in **≥ 0.4.1**. If you want to send traces **only** to your OTEL endpoint, set:
