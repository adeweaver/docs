...
If you want to trace some runs with different configuration than others, your environment doesn't support typical environment variables (such as Cloudflare Workers), or you'd prefer not to rely on environment variables directly, LangSmith allows you the tracing configuration programmatically.
