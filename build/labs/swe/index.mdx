...
Open SWE is an open-source cloud-based coding agent built with [LangGraph](/oss/python/javascript/langgraph/overview). It's designed to autonomously understand, plan, and execute code changes across entire repositories.
